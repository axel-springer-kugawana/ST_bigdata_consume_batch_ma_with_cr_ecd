...
for geoid, data_country, distribution_type, data_source in country_values:
    ...
    s3_path_json = f"s3://consume-batch-ma-with_cr_ecd-{ENV_NAME}/data/{data_country.lower()}/{distribution_type.lower()}/json/partitioncreateddate={GlobalVariables.today}"
    ...
    s3_path_csv = f"s3://consume-batch-ma-with_cr_ecd-{ENV_NAME}/data/{data_country.lower()}/{distribution_type.lower()}/csv/partitioncreateddate={GlobalVariables.today}"
